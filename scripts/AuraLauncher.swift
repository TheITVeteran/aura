...
final class AuraLauncherDelegate: NSObject, NSApplicationDelegate {
    ...
    private func baseAuraEnvironment() -> [String: String] {
        ...
        env["AURA_SAFE_BOOT_MLX_MEMORY_RATIO"] = "0.54"
        env["AURA_SAFE_BOOT_MLX_MEMORY_CAP_GB"] = "34"
        env["AURA_SAFE_BOOT_MLX_MEMORY_FLOOR_GB"] = "18"
        env["AURA_SAFE_BOOT_PROCESS_RSS_RATIO"] = "0.62"
        env["AURA_SAFE_BOOT_PROCESS_RSS_CAP_GB"] = "40"
    ...
    private func spawnViaTerminal(arguments: [String]) throws {
        ...
        export AURA_SAFE_BOOT_MLX_MEMORY_RATIO=0.54
        export AURA_SAFE_BOOT_MLX_MEMORY_CAP_GB=34
        export AURA_SAFE_BOOT_MLX_MEMORY_FLOOR_GB=18
        export AURA_SAFE_BOOT_PROCESS_RSS_RATIO=0.62
        export AURA_SAFE_BOOT_PROCESS_RSS_CAP_GB=40
