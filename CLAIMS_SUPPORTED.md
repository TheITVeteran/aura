...
* **Code / Evidence Path**:
  - Central gatekeeper implementation: [core/executive/authority_gateway.py](file:///Users/bryan/.aura/live-source/core/executive/authority_gateway.py)
  - Unified system interface: [core/container.py](file:///Users/bryan/.aura/live-source/core/container.py)
...
* **Code / Evidence Path**:
  - Memory subsystem: [core/memory/](file:///Users/bryan/.aura/live-source/core/memory/)
  - Long-term continuous experience stream: [tests/test_continuous_experience_stream.py](file:///Users/bryan/.aura/live-source/tests/test_continuous_experience_stream.py)
...
* **Code / Evidence Path**:
  - Homeostatic state tracking: [core/state/aura_state.py](file:///Users/bryan/.aura/live-source/core/state/aura_state.py)
  - Introspective state verification: [proof_kernel/tests/test_proof_kernel.py](file:///Users/bryan/.aura/live-source/proof_kernel/tests/test_proof_kernel.py)
...
* **Code / Evidence Path**:
  - Affect updating logic: [core/phases/affect_update.py](file:///Users/bryan/.aura/live-source/core/phases/affect_update.py)
...
* **Code / Evidence Path**:
  - Speculative path rollouts: [core/cognition/mcts_world_model.py](file:///Users/bryan/.aura/live-source/core/cognition/mcts_world_model.py)
...
* **Code / Evidence Path**:
  - Diagnostic ladder: [core/runtime/self_repair_ladder.py](file:///Users/bryan/.aura/live-source/core/runtime/self_repair_ladder.py)
...
* **Code / Evidence Path**:
  - Unified Will decision: [core/runtime/task_ownership.py](file:///Users/bryan/.aura/live-source/core/runtime/task_ownership.py)
...
* **Code / Evidence Path**:
  - Hardened sandbox boundaries: [tests/test_sandbox_hardening.py](file:///Users/bryan/.aura/live-source/tests/test_sandbox_hardening.py)
...
* **Code / Evidence Path**:
  - Strict mode configuration: [core/runtime/mode.py](file:///Users/bryan/.aura/live-source/core/runtime/mode.py)
  - Fail-closed container intercepts: [core/container.py](file:///Users/bryan/.aura/live-source/core/container.py)
