...
* **Code / Evidence Path**:
  - Central gatekeeper implementation: [core/executive/authority_gateway.py](file://<AURA_ROOT>/core/executive/authority_gateway.py)
  - Unified system interface: [core/container.py](file://<AURA_ROOT>/core/container.py)
...
* **Code / Evidence Path**:
  - Memory subsystem: [core/memory/](file://<AURA_ROOT>/core/memory/)
  - Long-term continuous experience stream: [tests/test_continuous_experience_stream.py](file://<AURA_ROOT>/tests/test_continuous_experience_stream.py)
...
* **Code / Evidence Path**:
  - Homeostatic state tracking: [core/state/aura_state.py](file://<AURA_ROOT>/core/state/aura_state.py)
  - Introspective state verification: [proof_kernel/tests/test_proof_kernel.py](file://<AURA_ROOT>/proof_kernel/tests/test_proof_kernel.py)
...
* **Code / Evidence Path**:
  - Affect updating logic: [core/phases/affect_update.py](file://<AURA_ROOT>/core/phases/affect_update.py)
...
* **Code / Evidence Path**:
  - Speculative path rollouts: [core/cognition/mcts_world_model.py](file://<AURA_ROOT>/core/cognition/mcts_world_model.py)
...
* **Code / Evidence Path**:
  - Diagnostic ladder: [core/runtime/self_repair_ladder.py](file://<AURA_ROOT>/core/runtime/self_repair_ladder.py)
...
* **Code / Evidence Path**:
  - Mutation safety analyzer: [core/self_modification/mutation_safety.py](file://<AURA_ROOT>/core/self_modification/mutation_safety.py)
  - Safe promotion pipeline: [core/self_modification/safe_modification.py](file://<AURA_ROOT>/core/self_modification/safe_modification.py)
...
* **Code / Evidence Path**:
  - Hardened sandbox boundaries: [tests/test_sandbox_hardening.py](file://<AURA_ROOT>/tests/test_sandbox_hardening.py)
...
* **Code / Evidence Path**:
  - Strict mode configuration: [core/runtime/mode.py](file://<AURA_ROOT>/core/runtime/mode.py)
  - Fail-closed container intercepts: [core/container.py](file://<AURA_ROOT>/core/container.py)
