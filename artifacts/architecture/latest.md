...
graph TD
    ...
    skills["skills<br/>79 files, 21403 lines"]
...
- Total `record_degradation()` calls: 3056
- Log-and-limp candidates: 2826
...
- `core/memory/episodic_memory.py`: 22
