...
from core.brain.llm.context_assembler_patch import _build_aura_now_block
...
def test_context_assembler_injects_state_grounded_aura_now_block() -> None:
    ...
    block = _build_aura_now_block(state, state.cognition.current_objective, compact=False)
