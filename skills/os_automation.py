...
The canonical implementation lives in ``core.skills.os_automation``.
...
__all__ = ["OSAutomationCompilerSkill", "OSAutomationInput"]


def __getattr__(name: str):
    if name not in __all__:
        raise AttributeError(name)
    module = import_module("core.skills.os_automation")
