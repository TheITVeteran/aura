...
* **[BOOT_CERTIFICATE.json](file:///Users/bryan/.aura/live-source/artifacts/certification/latest/BOOT_CERTIFICATE.json)**: Verification of successful headless server boot.
* **[SERVICE_MANIFEST.json](file:///Users/bryan/.aura/live-source/artifacts/certification/latest/SERVICE_MANIFEST.json)**: Declared owners, origins, and failure policies for all active services.
* **[CAPABILITY_MANIFEST.json](file:///Users/bryan/.aura/live-source/artifacts/certification/latest/CAPABILITY_MANIFEST.json)**: Hardcoded runtime limits and capabilities active in each mode.
* **[DEGRADATION_REPORT.json](file:///Users/bryan/.aura/live-source/artifacts/certification/latest/DEGRADATION_REPORT.json)**: Logs of system safety lockdown actions when critical services are lesioned.
* **[WORLD_RESULTS.jsonl](file:///Users/bryan/.aura/live-source/artifacts/certification/latest/WORLD_RESULTS.jsonl)**: Individual scorecards from the Aletheia Live Proof.
* **[ABLATION_SUMMARY.json](file:///Users/bryan/.aura/live-source/artifacts/certification/latest/ABLATION_SUMMARY.json)**: Quantitative baseline comparisons proving that each architectural module is causally load-bearing.
* **[CERTIFICATION_VERDICT.json](file:///Users/bryan/.aura/live-source/artifacts/certification/latest/CERTIFICATION_VERDICT.json)**: The final signed verdict assessing system capabilities.
...
* **[4-Hour Autonomy Telemetry](file:///Users/bryan/.aura/live-source/artifacts/certification/latest/SOAK_LOG_4H.json)**
* **[24-Hour Autonomy Telemetry](file:///Users/bryan/.aura/live-source/artifacts/certification/latest/SOAK_LOG_24H.json)**
* **[72-Hour Autonomy Telemetry](file:///Users/bryan/.aura/live-source/artifacts/certification/latest/SOAK_LOG_72H.json)**
...
1. **[CLAIMS_SUPPORTED.md](file:///Users/bryan/.aura/live-source/CLAIMS_SUPPORTED.md)**: Scientifically defensible capabilities (Governed execution, Persistent memory, Speculative MCTS search, Diagnostic self-repair) backed by explicit code locations.
2. **[CLAIMS_NOT_SUPPORTED.md](file:///Users/bryan/.aura/live-source/CLAIMS_NOT_SUPPORTED.md)**: Speculative, unproven, or metaphysical horizons (Artificial General Intelligence, Subjective Consciousness, Metaphysical Free Will) clearly demoted to prevent hyping.
