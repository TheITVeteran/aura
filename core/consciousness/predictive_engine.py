...
class PredictiveEngine:
    ...
    def compute_surprise(self, actual_state_summary: dict[str, Any], actual_substrate_x: np.ndarray | None = None) -> float:
    ...
    def compare_and_learn(self, current_substrate_x: np.ndarray) -> float:
        """Compare current substrate state with prediction and learn."""
        return self.compute_surprise({}, current_substrate_x)