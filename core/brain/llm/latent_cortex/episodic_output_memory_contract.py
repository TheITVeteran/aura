"""Pure receipt contract for query-scoped episodic output memory.

This module deliberately imports no tensor runtime.  The symbolic critic can
therefore reconstruct output-memory evidence without sharing the neural
implementation or its parameters.
"""
