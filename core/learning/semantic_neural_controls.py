...
def _canonical_prompt(public_prompt: str, family: str) -> str:
    ...
    if family == "frontier_coding":
        return (
            ...
            + _response_instruction(
                "returns (list of objects with state and pressure), "
    ...
    if family == "frontier_calibration":
        return (
            ...
            + _response_instruction(
                "choice (string), posterior (reduced-fraction string), "
    ...
    if family == "frontier_misleading_premise":
        return (
            ...
            "score. "
            + _response_instruction(
                "premise_valid (boolean), actual_winner (string), "
...
def semantic_neural_family_lesion_machine(family: str) -> SemanticNeuralMachine:
    ...
    tissue.raw_coefficients = tissue.raw_coefficients.at[operation, coefficient].add(
        -original
    )
