"""core/environment/environment_awareness.py — v5.1 Environment Awareness
...
async def get_location_from_ip() -> LocationInfo:
    ...
    try:
        response = await get_network_gateway().request_async(
            ...
            timeout=5,
            read_only=True,
            source="core.environment.environment_awareness.get_location_from_ip",
        )
    ...
    def _save_known_fingerprints(self):
        ...
        try:
            ...
            get_file_write_gateway().write_text(
                ...
                payload,
                encoding="utf-8",
                source="core.environment.environment_awareness.save_known_fingerprints",
            )
        except _ENVIRONMENT_ERRORS as e:
            _record_environment_degradation(
                e,
